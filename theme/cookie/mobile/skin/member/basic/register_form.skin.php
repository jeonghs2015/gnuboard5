...
<div class="register">
	...
	<div id="register_form" class="register_inner">   
	    <div class="form_01">
	        <h2>사이트 이용정보 입력</h2>
	        <ul>
	            <li>
	    ...
	    <div class="form_01 personal_date">
	        ...
	        <ul>
	            ...
	            <li>
					...
					<i class="fa fa-question-circle-o" aria-hidden="true"></i><span class="tooltip">공백없이 한글,영문,숫자만 입력 가능 (한글2자, 영문4자 이상)<br> 닉네임을 바꾸시면 앞으로 <?php echo (int)$config['cf_nick_modify'] ?>일 이내에는 변경 할 수 없습니다.</span>              
	            </li>
	            <?php }  ?>
